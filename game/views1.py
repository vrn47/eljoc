...
#    teamdb_2ndL = Teamsdb.objects.filter(teams__editions=currentedition,teams__pos=2).order_by('teams__grp').exclude(teams__grp='L').exclude(fed=teamdb_1stL.fed)
    ...
    teamPO_7 = Teamsdb.objects.filter(teams__id=181) | Teamsdb.objects.filter(teams__id=188).order_by('teams__pos')
    teamPO_8 = Teamsdb.objects.filter(teams__id=171) | Teamsdb.objects.filter(teams__id=203).order_by('teams__pos')
    teamPO_9 = Teamsdb.objects.filter(teams__id=176) | Teamsdb.objects.filter(teams__id=180).order_by('teams__pos')
    teamPO_A = Teamsdb.objects.filter(teams__id=182) | Teamsdb.objects.filter(teams__id=210).order_by('teams__pos')
    teamPO_B = Teamsdb.objects.filter(teams__id=169) | Teamsdb.objects.filter(teams__id=189).order_by('teams__pos')
    teamPO_C = Teamsdb.objects.filter(teams__id=172) | Teamsdb.objects.filter(teams__id=178).order_by('teams__pos')
    teamPO_D = Teamsdb.objects.filter(teams__id=185) | Teamsdb.objects.filter(teams__id=192).order_by('teams__pos')
