...
#    teamdb_2ndK = Teamsdb.objects.filter(teams__editions=currentedition,teams__pos=2).order_by('teams__grp').exclude(teams__grp='K').exclude(fed=teamdb_1stK.fed)
#    teamdb_2ndL = Teamsdb.objects.filter(teams__editions=currentedition,teams__pos=2).order_by('teams__grp').exclude(teams__grp='L').exclude(fed=teamdb_1stL.fed)
    teamPO_1 = Teamsdb.objects.filter(teams__id=207) | Teamsdb.objects.filter(teams__id=194).order_by('teams__pos')
    teamPO_2 = Teamsdb.objects.filter(teams__id=173) | Teamsdb.objects.filter(teams__id=184).order_by('teams__pos')
    teamPO_3 = Teamsdb.objects.filter(teams__id=177) | Teamsdb.objects.filter(teams__id=199).order_by('teams__pos')
    teamPO_4 = Teamsdb.objects.filter(teams__id=174) | Teamsdb.objects.filter(teams__id=175).order_by('teams__pos')
    teamPO_5 = Teamsdb.objects.filter(teams__id=197) | Teamsdb.objects.filter(teams__id=195).order_by('teams__pos')
    teamPO_6 = Teamsdb.objects.filter(teams__id=168) | Teamsdb.objects.filter(teams__id=198).order_by('teams__pos')
    teamPO_7 = Teamsdb.objects.filter(teams__id=181) | Teamsdb.objects.filter(teams__id=0).order_by('teams__pos')
    teamPO_8 = Teamsdb.objects.filter(teams__id=0) | Teamsdb.objects.filter(teams__id=0).order_by('teams__pos')
    teamPO_9 = Teamsdb.objects.filter(teams__id=176) | Teamsdb.objects.filter(teams__id=0).order_by('teams__pos')
    teamPO_A = Teamsdb.objects.filter(teams__id=182) | Teamsdb.objects.filter(teams__id=210).order_by('teams__pos')
    teamPO_B = Teamsdb.objects.filter(teams__id=169) | Teamsdb.objects.filter(teams__id=0).order_by('teams__pos')
    teamPO_C = Teamsdb.objects.filter(teams__id=0) | Teamsdb.objects.filter(teams__id=0).order_by('teams__pos')
    teamPO_D = Teamsdb.objects.filter(teams__id=185) | Teamsdb.objects.filter(teams__id=0).order_by('teams__pos')
    ...
    teamPO_G = Teamsdb.objects.filter(teams__id=0) | Teamsdb.objects.filter(teams__id=1).order_by('teams__pos')
    teamRo16_1 = Teamsdb.objects.filter(teams__id=140) | Teamsdb.objects.filter(teams__id=134).order_by('teams__pos')
    teamRo16_2 = Teamsdb.objects.filter(teams__id=158) | Teamsdb.objects.filter(teams__id=136).order_by('teams__pos')
    teamRo16_3 = Teamsdb.objects.filter(teams__id=161) | Teamsdb.objects.filter(teams__id=142).order_by('teams__pos')
    teamRo16_4 = Teamsdb.objects.filter(teams__id=144) | Teamsdb.objects.filter(teams__id=132).order_by('teams__pos')
