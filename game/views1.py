...
#    teamdb_2ndH = Teamsdb.objects.filter(teams__editions=currentedition,teams__pos=2).order_by('teams__grp').exclude(teams__grp='H').exclude(fed=teamdb_1stH.fed)
    ...
    teamRo16_4 = Teamsdb.objects.filter(teams__id=120) | Teamsdb.objects.filter(teams__id=127).order_by('teams__pos')
    teamRo16_5 = Teamsdb.objects.filter(teams__id=119) | Teamsdb.objects.filter(teams__id=107).order_by('teams__pos')
    teamRo16_6 = Teamsdb.objects.filter(teams__id=118) | Teamsdb.objects.filter(teams__id=89).order_by('teams__pos')
